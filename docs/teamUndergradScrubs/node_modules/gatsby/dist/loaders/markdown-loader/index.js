...
var md = function md(linkPrefix, shouldPrefix) {
  return (0, _markdownIt2.default)({
    html: true,
    linkify: true,
    typographer: true,
    highlight: highlight,
    replaceLink: function replaceLink(link) {
      if (shouldPrefix && _path2.default.isAbsolute(link)) {
...
module.exports = function (content) {
  ...
  var linkPrefix = query.config.linkPrefix || '';
  var shouldPrefix = query.shouldPrefix;

  var meta = (0, _frontMatter2.default)(content);
  var body = md(linkPrefix, shouldPrefix).render(meta.body);
