...
module.exports = function (locals, callback) {
  (0, _reactRouter.match)({ routes: routes, location: (0, _gatsbyHelpers.prefixLink)(locals.path) }, function (error, redirectLocation, renderProps) {
    if (error) {
      ...
      var componentToWrap = function componentToWrap() {
        return _react2.default.createElement(_reactRouter.RouterContext, renderProps);
      };
      var body = void 0;
      var component = void 0;

      if (_gatsbySsr.wrapRootComponent) {
        component = (0, _gatsbySsr.wrapRootComponent)(componentToWrap);
      } else {
      ...
      var html = '<!DOCTYPE html>\n ' + (0, _server.renderToStaticMarkup)( // eslint-disable-next-line comma-dangle
